...
public class TestException {
    public static void main(String[] args) {
        ...
        /**
         * [unchecked exception]
         * RuntimeError>ArithmeticException 分母不得為零            
         * Java returned: 1  此為JVM內回傳運行不正確的值為非0
         * 解決方法：加上判斷式>>事前防範。
         * 事後處理>>印出錯誤訊息(本範例)
         */
        try{
...
//            Logger.getLogger(TestException.class.getName()).log(Level.SEVERE, null, ex);   //此行為自動修正產生，與以下兩行有相同功能
            System.out.println("發生嚴重錯誤：" + ex);
            ex.printStackTrace();  //詳細錯誤訊息
        }
